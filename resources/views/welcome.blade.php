...
<head>
    ...
    <link href="assets/vendor/jquery-nice-select/css/nice-select.css" rel="stylesheet" type="text/css" />
...
***********************************-->
        <div class="footer">
            <div class="copyright border-top">
                <p>Copyright © Designed by <a href="https://reconnect.co.tz"
                        target="_blank">Reconnect Company Ltd</a> 2023</p>
            </div>
        </div>
        <!--**********************************
    Footer end
