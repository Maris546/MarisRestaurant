                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12">
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    ...
                                    <a href="favourite_menu.html" class="text-primary">View all <i
                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card dishe-bx exclusive">
                                                <div class="card-header border-0 pb-0 pt-0 pe-3">
                                                    <span
                                                        class="badge badge-lg badge-warning side-badge">Exclusive</span>
                                                    <i class="fa-solid fa-heart ms-auto c-heart c-pointer"></i>
                                                </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="swiper-slide">
                                                <div class="card dishe-bx b-hover review style-1">
                                                    <div
                                                        class="card-body text-center py-3 d-flex justify-content-center">
                                                        <img src="assets/images/popular-img/review-img/pic-1.jpg"
                                                            alt="">
                                                    ...
                                                    <div class="card-footer pt-0 border-0 text-center">
                                                        <div>
                                                            <a href="javascript:void(0);">
                                                                <h4 class="mb-0">Pepperoni Pizza</h4>
                                                            </a>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="card dishe-bx b-hover review style-1">
                                                    ...
                                                    <div class="card-body text-center py-3">
                                                        <img src="assets/images/popular-img/review-img/pic-2.jpg"
                                                            alt="">
                                                    </div>
                                                    <div class="card-footer pt-0 border-0 text-center">
                                                        <div>
                                                            <a href="javascript:void(0);">
                                                                <h4 class="mb-0">Japan Ramen</h4>
                                                            </a>
                                                            <h3 class="font-w700 text-primary">$5.59</h3>
                                                            <div
                                                                class="d-flex align-items-center justify-content-center">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="swiper-slide">
                                                <div class="card dishe-bx b-hover review style-1">
                                                    ...
                                                    <div class="card-body text-center py-3">
                                                        <img src="assets/images/popular-img/review-img/pic-3.jpg"
                                                            alt="">
                                                    </div>
                                                    <div class="card-footer pt-0 border-0 text-center">
                                                        <div>
                                                            <a href="javascript:void(0);">
                                                                <h4 class="mb-0">Fried Rice</h4>
                                                            </a>
                                                            <a href="javascript:void(0);">
                                                                <h3 class="font-w700 text-primary">$5.59</h3>
                                                            </a>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="swiper-slide">
                                                <div class="card dishe-bx b-hover review style-1">
                                                    <div class="card-header border-0 pt-0 pb-0">
                                                        <i
                                                            class="fa-solid fa-heart ms-auto c-heart c-pointer style-1"></i>
                                                    </div>
                                                    <div class="card-body text-center py-3">
                                                        <img src="assets/images/popular-img/review-img/pic-1.jpg"
                                                            alt="">
